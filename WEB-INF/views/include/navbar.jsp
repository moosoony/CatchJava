    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link click-scroll" href="${contextPath}/mystudy/list">My Study Room</a>
                </li>

<%--                <li class="nav-item dropdown">--%>
<%--                    <a class="nav-link click-scroll dropdown-toggle" href="${contextPath}/mystudy/list"--%>
...
<%--                </li>--%>
                ...
                <c:if test="${user.userid != null}">
                    <li class="nav-item dropdown">
                        <a class="nav-link click-scroll dropdown-toggle" href="#section_5"
                           ...
                           aria-expanded="false">${user.userid} Profile</a>
                ...
                <c:if test="${user.userid == null}">
                    <li class="nav-item ms-3">
                        <a class="nav-link custom-btn custom-border-btn btn" href="${contextPath}/user/signin">Sign
                            In</a>
                    </li>
                </c:if>
                ...
                <c:if test="${user.userid != null}">
                    <li class="nav-item ms-3">
                        <a class="nav-link custom-btn custom-border-btn btn" href="${contextPath}/user/signout">Sign
                            Out</a>
                    </li>
                </c:if>
