                ...
                <div class="card bg-dark text-white" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        ...
                        <div class="mb-md-5 mt-md-4 pb-5">
                            ...
                            <div class="form-outline form-white col-5 mb-4">
                                <input type="text" id="userid" class="form-control form-control-lg" placeholder="Id">
                            ...
                            <div class="form-outline form-white col-10 mb-4">
                            ...
                            <div class="form-outline form-white col-5 mb-4">
                                ...
                                <label class="form-label" for="postnumber"/>
                            </div>
                            ...
                            <div class="form-outline form-white col-5 mb-4">
                                <input type="text" id="sex" class="form-control form-control-lg" placeholder="sex">
